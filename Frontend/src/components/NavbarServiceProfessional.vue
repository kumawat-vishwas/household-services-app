<template>
    <nav class="navbar border-bottom mb-3 navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <router-link to="/service-professional/dashboard" class="navbar-brand bold" style="margin: 0px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <router-link to="/service-professional/dashboard" class="nav-link"><p class="bi bi-house"><span class="mx-1">Home</span></p></router-link>
                    <router-link to="/service-professional/profile" class="nav-link"><p class="bi bi-person-square"><span class="mx-1">Profile</span></p></router-link>
                    <router-link to="/service-professional/summary" class="nav-link"><p class="bi bi-graph-up"><span class="mx-1">Summary</span></p></router-link>
